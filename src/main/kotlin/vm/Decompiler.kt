 ...
 *
 * These assumptions are not part of the virtual machine architecture specification, but they hold
 * for challenge.bin.
 */
class Decompiler {

  fun decompile(programBytes: ByteArray, printer: Printer) {
    ...
    while (index < intInstructions.size) {
      ...
      if (intInstruction.representsOpCode()) {
        ...
        printer.printLine(instructionString)
        ...
        printer.printLine(intInstruction.toString())
